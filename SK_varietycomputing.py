...
#                         print(end_frame)
                        handleftvar = numpy.var(Skeleton_matrix[:, 0]) + numpy.var(Skeleton_matrix[:, 1]) + numpy.var(Skeleton_matrix[:, 2])
                        handrightvar = numpy.var(Skeleton_matrix[:, 3]) + numpy.var(Skeleton_matrix[:, 4]) + numpy.var(Skeleton_matrix[:, 5])
