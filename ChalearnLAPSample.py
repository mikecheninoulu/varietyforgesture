...
class Skeleton(object):
    ...
    def __init__(self,data):
        ...
        self.joins=dict();
        pos=0
        self.joins['SpineBase']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['SpineMid']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['ShoulderCenter']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['Head']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['ShoulderLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['ElbowLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['WristLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['HandLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['ShoulderRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['ElbowRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['WristRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['HandRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['HipLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['KneeLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['AnkleLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['FootLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['HipRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['KneeRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['AnkleRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['FootRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
        pos=pos+11
        self.joins['SpineShoulder']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))        
        pos=pos+11
        self.joins['HandTipLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))        
        pos=pos+11
        self.joins['ThumbLeft']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))        
        pos=pos+11
        self.joins['HandTipRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))        
        pos=pos+11
        self.joins['ThumbRight']=(map(float,data[pos:pos+3]),map(float,data[pos+3:pos+7]),map(float,data[pos+7:pos+9]))
    def getAllData(self):
    ...
    def toImage(self,width,height,bgColor):
        ...
        SkeletonConnectionMap = (['SpineBase','Spine'],['SpineMid','ShoulderCenter'],['ShoulderCenter','Head'],['ShoulderCenter','ShoulderLeft'], \
                                 ['ShoulderLeft','ElbowLeft'],['ElbowLeft','WristLeft'],['WristLeft','HandLeft'],['ShoulderCenter','ShoulderRight'], \
                                 ['ShoulderRight','ElbowRight'],['ElbowRight','WristRight'],['WristRight','HandRight'],['SpineBase','HipRight'], \
                                 ['HipRight','KneeRight'],['KneeRight','AnkleRight'],['AnkleRight','FootRight'],['SpineBase','HipLeft'], \
...
class GestureSample(object):
    ...
    def __init__ (self,fileName,validation = 0):
        ...
        if validation == 0: 
            ...
            labelsPath="/home/chaoyu/MasterThesis/datafortest/ValidLabel"+os.path.sep + self.seqID + '_labels.csv'
