...
#     model 3
#    dbn = GRBM_DBN(numpy_rng=numpy_rng, n_ins=528, hidden_layers_sizes=[2000, 2000, 1000], n_outs=231, finetune_lr=0.1)
    ...
    filename = 'dbn_model1_'+strftime("%Y-%m-%d-%H-%M-%S", gmtime())
    dbn.save(filename)
