...
# just to accommodate some frame didn't start right from the begining
    start_label = numpy.concatenate((range(0,70,10), range(1,70,10), range(2,70,10), range(3,70,10) )) #jw
    end_label   = numpy.concatenate((range(9,70,10), range(8,70,10), range(7,70,10), range(6,70,10) )) #jw
    begin_frame = []
    end_frame = []
    pred_label = []
